    ...
    $.ajax({
        ...
        success: (response) => {
            $.each(response, (index, val) => {
                ...
                tablaHTML += "<td style='text-align: left; vertical-align: middle; padding:2px;'><span style='font-size:12px; cursor:pointer; color:blue; text-decoration: underline;' title='Detalle de Ciudadano'> <a href='/Apoyo/Ciudadanoes/DetalleCiudadano?id=" + val.publicidadBase.ciudadanoId + "'>" + val.nombreCiudadano + "</a></span></td>";
